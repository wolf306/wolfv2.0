		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD BOT*',
			...
			const ownerNumber = ["556296281966@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"556296281966@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["556296281966@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["556296281966@s.whatsapp.net"]//ubah nomor lo
			const premium = ["556296281966@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net","12267740582@s.whatsapp.net"]
...
if (text.includes("ip"))
  ...
  frhan.sendMessage(id, hasil, MessageType.text); 
 })
 }
...
//msc fim
			...
			data = fs.readFileSync('./src/darkjokes.js');
                ...
                sendImage(hasil, mek, '*LucasssメMemes 🤑🔥*')
	}
